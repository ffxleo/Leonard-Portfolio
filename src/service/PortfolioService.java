...
public class PortfolioService {
    ...
    public Portfolio createPortfolio() {
        ...
        List<WorkExperience> workHistory = Arrays.asList(
            new WorkExperience(
        ...
        List<String> freelanceProjects = Arrays.asList(
        ...
        return new Portfolio(person, workHistory, education, skills, freelanceProjects);
    }
}
