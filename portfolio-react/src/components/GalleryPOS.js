...
function GalleryPOS() {
  ...
  const galleryImages = [
    ...
    { id: 5, src: '/pos/deploy1.jpg', caption: 'System Deployment - Setup' },
    { id: 6, src: '/pos/deploy2.jpg', caption: 'System Deployment - Configuration' },
    { id: 7, src: '/pos/deploy3.jpg', caption: 'System Deployment - Testing' },
    { id: 8, src: '/pos/deploy4.jpg', caption: 'System Deployment - Live' }
  ];
